<%@ Page Title=":: GroupDocs Conversion WebForms Demo with Watermark" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GroupDocsConversionWebFormsDemoWithWatermark._Default" %>

<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div style="padding: 20px 20px 20px 20px">
        <div class="panel panel-default" style="width: 90%;">
            <div class="panel-heading"><b>GroupDocs Conversion WebForms Demo with Watermark</b></div>
            <div class="panel-body">
                <span class="label label-default">
                    <asp:Label runat="server" ID="Label1"></asp:Label></span>
                <br />
                <span class="label label-default">Watermark Text:</span>
                <asp:TextBox ID="textboxWatermarkText" runat="server" Width="300px" MaxLength="100" CssClass="list-group-item-text" Text="GroupDocs.Conversion"></asp:TextBox>
                <br />
                .
