...
using System.Xml;
using GroupDocsConversionVisualStudioPlugin.XML;
    ...
    public partial class SampleWizardPage : Form
    {
        ...
        bool CopyAndCreateProject()
        {
            ...
            try
            {
                ...
                string[] projectFiles = Directory.GetFiles(Path.Combine(destinationPath, (rdbCSharp.Checked ? "CSharp/GroupDocs.Conversion.Examples.CSharp" : "VisualBasic/GroupDocs.Conversion.Examples.VisualBasic")), (rdbCSharp.Checked ? "*.csproj" : "*.vbproj"));
        ...
        private void PopulateTreeView(string dirPath)
        {
            ...
            {
                //MessageBox.Show("In Tree: " + exp.Message);
            }
        }
