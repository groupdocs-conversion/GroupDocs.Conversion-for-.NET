...
namespace GroupDocsConversionVisualStudioPlugin
{
    public class Connect : Extensibility.IDTExtensibility2, IDTCommandTarget
    {
        ...
        private const string WORDS_COMMAND_NAME = "GroupDocsWordsVSPlugin";
        private const string WORDS_COMMAND_CAPTION = "New GroupDocs.Conversion Example Project";
        private const string WORDS_COMMAND_TOOLTIP = "Download and Run GroupDocs.Conversion for .NET API Examples";
