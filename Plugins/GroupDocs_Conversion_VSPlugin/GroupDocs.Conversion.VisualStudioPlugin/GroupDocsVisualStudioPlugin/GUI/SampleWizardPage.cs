...
namespace GroupDocsConversionVisualStudioPlugin.GUI
{
    public partial class SampleWizardPage : Form
    {
        ...
        public SampleWizardPage(DTE2 application)
        {
            ...
            PopulateTreeView(repoPath + "/Examples/" + (rdbCSharp.Checked ? "GroupDocs.Conversion.Examples.CSharp" : "GroupDocs.Conversion.Examples.VisualBasic"));
        ...
        bool CopyAndCreateProject()
        {
            ...
            //string sampleSourcePath = "GroupDocs.Conversion";
