...
namespace GroupDocs.Conversion.Examples.CSharp.BasicUsage
{
    ...
    /// https://docs.groupdocs.com/conversion/net/convert-pdf-to-docx
    /// </summary>
    internal static class ConvertPdfToDocx
    {
        public static void Run()
        {
            string outputFolder = Constants.GetOutputDirectoryPath();
            string outputFile = Path.Combine(outputFolder, "pdf-converted-to.docx");
