...
{
    /// <summary>
    /// This example demonstrates how to convert VSX file into PNG format.
    /// For more details about Vector Scalar Extension (.vsx) to Portable Network Graphic (.png) conversion please check this documentation article 
    /// https://docs.groupdocs.com/conversion/net/convert-vsx-to-png
    /// </summary>
